  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <div class="float-lg-right text-white" style="font-size: .8rem; float: right;">
      <form class="form-inline">
        ...
        <input type="text" class="form-control mb-1 mt-1 form-control-sm bg-warning border-white text-white text-center" id="t_dateDepart" value="<?php echo $dateDepart; ?>" size="10">&nbsp;&nbsp;
        ...
        <input type="text" class="form-control mb-1 mt-1 form-control-sm bg-warning border-white text-white text-center input-number" id="t_noAdult" value="<?php echo $noAdult; ?>" size="2">&nbsp;&nbsp;
        <i class="fas fa-child fa-sm mb-1 mt-1" style="font-size: 1.2rem;"></i>&nbsp;
        <span class="">Children&nbsp;&nbsp;</span>
        <input type="text" class="form-control mb-1 mt-1 form-control-sm bg-warning border-white text-white text-center input-number" id="t_noChild"  value="<?php echo $noChild; ?>" size="2">
