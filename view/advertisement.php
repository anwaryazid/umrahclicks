...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary text-md">List of Advertisement <button style="float:right" class="btn btn-sm btn-primary text-xs <?= $create ?>" onclick="addAdvert();">Add Advertisement</button></h6> 
  </div>
  <div class="card-body">
