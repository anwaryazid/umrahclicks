...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">List of Packages <button class="btn btn-sm btn-success text-xs" data-toggle="modal" data-target="#addPackageModal">Add Packages</button></h6> 
  </div>
  <div class="card-body">
