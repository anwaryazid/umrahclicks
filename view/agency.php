...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">List of Agency <button class="btn btn-sm btn-success text-xs" data-toggle="modal" data-target="#addAgencyModal">Add Agency</button></h6> 
  </div>
  <div class="card-body">
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>          
          <tr>
            ...
            <td class="text-center">
              <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#editAgencyModal" title="Edit"><i class="fas fa-pencil-alt fa-sm"></i></button>
