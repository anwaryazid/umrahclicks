<div class="modal fade" data-backdrop="static" id="editCountryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-primary" id="exampleModalLabel">View Country</h5>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-outline-primary btn-sm" href="#" data-toggle="modal" data-dismiss="modal" onClick="showAlert('Country',1,2);">Save</a>
      </div>
    </div>
  </div>
</div>