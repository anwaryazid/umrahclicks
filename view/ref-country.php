  ...
  <div class="col-md-12">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary text-md">List of Country <button style="float:right" class="btn btn-sm btn-primary text-xs <?= $create ?>" onclick="addCountry();">Add Country</button></h6> 
      </div>
      <div class="card-body">        
